...
char doagain = 'k'; 
 ...
 cout << "Es gibt folgende dynamische Kreuzungen:" << endl;
 cout << "Wird ein + ueberquert, drehen sich die Waende!" << endl;
 cout << "Wird ein R ueberquert, verschiebt sich Block 0 im Uhrzeigersinn.\n";
 cout << "Wird ein L ueberquert, verschiecht sich Bock 0 gegen den Uhrzs.\n";
