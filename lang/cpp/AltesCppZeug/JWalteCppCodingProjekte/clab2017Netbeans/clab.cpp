...
void setzeKreuzung(int &playerX, int &playerY, char move) {
  ...
  switch (move) {
  case 'w':
    labyrinth_original[playerY-1][playerX] = 'X'; 
    labyrinth_original[playerY+1][playerX] = 'X'; 
  ...
  case 'a':
    ...
    labyrinth_original[playerY+1][playerX] = ' '; 
    labyrinth_original[playerY][playerX-1] = 'X'; 
    labyrinth_original[playerY][playerX+1] = 'X'; 
    playerX -= 2;
    break;
  case 'd':
...
void setze3erK(int &playerX, int &playerY, int rentry, int rexit, int rblock, int rplayer) {
  ...
  if ((zeichenAnPosition(playerX, playerY) == 'X') || (zeichenAnPosition(playerX, playerY) == '0'))
    move = 'r';
...
char doagain = 'k'; 
 ...
 do {
   ...
   if (move == 'w') {
     moveEval = playerY - 1;
     if (zeichenAnPosition(playerX,moveEval) != 'X') {
       if (zeichenAnPosition(playerX,moveEval) != '0') {
	 playerY--; 
	   RorL = zeichenAnPosition(playerX,playerY);
	 if (zeichenAnPosition(playerX,moveEval) == '+') {
	   if ((zeichenAnPosition(playerX, playerY - 2) == 'X') || (zeichenAnPosition(playerX, playerY - 2) == '0'))
	     move = 'r';
     ...
     moveEval = playerX - 1;
     if (zeichenAnPosition(moveEval,playerY) != 'X') {
       if (zeichenAnPosition(moveEval,playerY) != '0') {
	 playerX--; 
	   RorL = zeichenAnPosition(playerX,playerY);
	 if (zeichenAnPosition(moveEval,playerY) == '+') {
	   if ((zeichenAnPosition(playerX - 2, playerY) == 'X') || (zeichenAnPosition(playerX - 2, playerY) == '0'))
	     move = 'r';
	   setzeKreuzung(playerX,playerY,move);
	 }
	 else if ((RorL == 'R') || (RorL == 'L')) {
