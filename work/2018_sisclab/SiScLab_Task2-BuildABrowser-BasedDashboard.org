...
- [[https://colab.research.google.com/notebooks/charts.ipynb][google colab charts (live example: matplotlib seaborn altair plotly bokeh)]]
- [[https://www.anaconda.com/blog/developer-blog/python-data-visualization-2018-why-so-many-libraries/][Anaconda Blog: Python Data Visualization 2018: Part 1]], [[https://www.anaconda.com/python-data-visualization-2018-moving-toward-convergence/][Part 2]], [[https://www.anaconda.com/python-data-visualization-2018-where-do-we-go-from-here/][Part 3]]
  - date: 2018
  - best overview
...
** Jupyter (General)
*** Resources
- [[https://danmackinlay.name/notebook/jupyter.html][danmackinlay.name/notebook/jupyter]] all about jupyter for science WIP
*** Extension packages
